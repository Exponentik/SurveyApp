        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<int>(type: "integer", nullable: false),
                    AnswerIds = table.Column<List<int>>(type: "integer[]", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResultAnswer", x => new { x.ResultId, x.AnswerId });
                    table.ForeignKey(
                        name: "FK_Answer_Result",
                        column: x => x.ResultId,
                        principalSchema: "public",
